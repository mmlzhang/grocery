...
house_facility = db.Table(
    'eh_house_facility',
    db.Column('house_id', db.Integer, db.ForeignKey('eh_house_info.id'), primary_key=True),  # 房屋编号
    db.Column('facility_id', db.Integer, db.ForeignKey('eh_facility_info.id'), primary_key=True)  # 设施编号
)
...
class House(BaseModel, db.Model):
    ...
    __tablename__ = 'eh_house_info'

    id = db.Column(db.Integer, primary_key=True)  # 房屋编号
    user_id = db.Column(db.Integer, db.ForeignKey('eh_user_profile.id'), nullable=False)  # 房屋主人的用户编号
    area_id = db.Column(db.Integer, db.ForeignKey('eh_area_info.id'), nullable=False)  # 归属地的区域编号
...
class Facility(BaseModel, db.Model):
    ...
    __tablename__ = 'eh_facility_info'
...
class HouseImage(BaseModel, db.Model):
    ...
    __tablename__ = 'eh_house_image'

    id = db.Column(db.Integer, primary_key=True)
    house_id = db.Column(db.Integer, db.ForeignKey('eh_house_info.id'), nullable=False)  # 房屋编号
...
class Order(BaseModel, db.Model):
    ...
    __tablename__ = 'eh_order_info'

    id = db.Column(db.Integer, primary_key=True)  # 订单编号
    user_id = db.Column(db.Integer, db.ForeignKey('eh_user_profile.id'), nullable=False)  # 下订单的用户编号
    house_id = db.Column(db.Integer, db.ForeignKey('eh_house_info.id'), nullable=False)  # 预订的房间编号
